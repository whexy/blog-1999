...
import SubscribePic from "../../public/img/subscribe.png";

const Ending = () => {
  return (
    <div className="max-w-3xl mx-auto mb-10 ">
      <div className="mx-1 secondbg rounded sm:rounded-full border overflow-hidden dark:text-white">
        <div className="grid grid-cols-3 space-x-2">
          <div className="bg-gradient-to-r from-red-100 to-rose-100 col-span-1 grid place-items-center">
            <Image
              src={SubscribePic}
              alt="please subscribe!"
              width="150"
              height="150"
              quality="100"
            />
