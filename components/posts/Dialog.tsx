...
export const Dialog = ({ children }) => {
  return (
    <div className="not-prose ml-4 flex break-inside-avoid-page items-center justify-end">
      <div className="rounded border border-red-200/80 bg-red-200/20 p-3 font-article text-sm">
        {children}
      </div>
...
export const DialogBack = ({ children }) => {
  return (
    <div className="not-prose mt-2 mr-4 flex items-center justify-start">
      ...
      <div className="rounded border border-blue-200/80 bg-blue-200/20 p-3 font-article text-sm">
        {children}
      </div>
    </div>
  );
