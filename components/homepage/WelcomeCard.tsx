  ...
  return (
    <>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="absolute right-4 bottom-4 grid place-items-center rounded-full bg-neutral-200 transition-all hover:ring-2 hover:ring-gray-700 dark:bg-neutral-700 dark:hover:ring-gray-300"
      >
        <button className="umami--click--github-button h-10 w-10 rounded-full p-2">
          <svg
            viewBox="0 0 24 24"
