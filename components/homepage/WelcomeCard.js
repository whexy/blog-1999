export default function WelcomeCard() {
  return (
    <>
      <div className="max-w-3xl mx-auto bg-cover bg-mojave dark:bg-mojave_dark md:h-[272px] rounded-xl w-full mt-10 overflow-hidden">
        <div className="grid md:grid-cols-3 mx-auto">
          <div className="md:col-span-1 grid place-items-center overflow-hidden">
            <img
              className="relative w-1/2 md:w-auto h-auto md:h-[240px] rounded-b-full md:rounded-none md:mt-[32px] overflow-hidden object-cover"
              alt="me waving"
              src="/img/hello.webp"
            />
          </div>
          <div className="md:col-span-2 place-self-center px-2 md:px-5 rounded-xl relative flex items-center leading-5 mx-1 my-3 md:ml-0 md:mr-3 md:pb-0 backdrop-blur-lg backdrop-brightness-50 select-none">
            <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="absolute right-4 bottom-4 w-12 h-12 rounded-full bg-black-readable/20 hover:bg-black-readable/30 grid place-content-center"
            >
