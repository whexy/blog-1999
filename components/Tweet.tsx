/**
 * @see https://github.com/leerob/leerob.io/blob/main/components/tweet.tsx
 */
...
export default function Tweet({
  ...
  return (
    <div className="tweet my-4 mx-auto max-w-xl rounded-lg border border-neutral-200 bg-white px-6 py-4 dark:border-neutral-800 dark:bg-neutral-900">
