...
<Callout title="Project naming" icon="🍎">
  OK, I'm actually pretty proud of the naming this time. I'm calling
  it `simpple-vm`. First, it's **simple**—that's the whole point.
  Second, it's for Apple hardware. And third, because virtualization
  is basically **sim**ulating the A**pple** silicon. See what I did
  there? The triple 'p' ties it all together.
</Callout>

## A minimal example

Alright, time to get our hands dirty! Actually, scratch that—since we're diving deep into ARM territory, let's get our _arms_ dirty!
...
| ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | --------------------- |
| [saurvs/hypervisor-rs](https://github.com/saurvs/hypervisor-rs)                                   | Early Rust bindings for Hypervisor Framework               | ❌                    |
| [Impalabs/applevisor](https://github.com/Impalabs/applevisor)                                     | Rust bindings specifically for Apple Silicon               | ✅                    |
| [marysaka/ahv](https://github.com/marysaka/ahv)                                                   | Another set of Apple Silicon Hypervisor bindings           | ✅                    |
| [RWTH-OS/xhypervisor](https://github.com/RWTH-OS/xhypervisor)                                     | Fork of ancient `hypervisor-rs`, updated for Apple Silicon | ✅                    |
| [cloud-hypervisor/hypervisor-framework](https://github.com/cloud-hypervisor/hypervisor-framework) | "High level" Rust bindings (no docs)                       | ✅                    |
...
<Dialog>
  Spoiler alert! I eventually write my own Rust bindings, which you'll
  see in a later series.
</Dialog>
